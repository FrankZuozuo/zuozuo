...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAI1PdnwD8ccDna";
    static final String accessKeySecret = "xZiWyKQAnWKno0Ut7MX6pPsRlAVRun";
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("13526401709");
        //必填:短信签名-可在短信控制台中找到
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("13526401709");
        //可选-流水号
